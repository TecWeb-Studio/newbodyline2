  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0a0a0a]">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#dc2626]/10 rounded-full blur-[100px] animate-pulse delay-1000" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          >
            <span className="block text-[#fafafa]">{t('title')}</span>
            <span className="block gradient-text mt-2">{t('titleAccent')}</span>
          </motion.h1>
      ...
      >
        <div className="flex flex-col items-center gap-2 text-[#71717a]">
          ...
          <motion.div
            ...
            className="w-6 h-10 rounded-full border-2 border-[#3f3f46] flex justify-center pt-2"
          >
